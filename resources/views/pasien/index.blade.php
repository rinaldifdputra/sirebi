...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            <div class="mb-4">
                <a href="{{ route('pasien.create') }}" class="btn btn-success"><i class="fa fa-user-plus"></i> Tambah Data</a>
            </div>
                ...
                <tbody>
                    @foreach ($users as $key => $user)
                        <tr>
                            ...
                            <td>{{ $user->no_hp }}</td>
                            <td>
                                <a href="{{ route('pasien.show', $user->id) }}" class="btn btn-info btn-sm"><i
                                        class="fa fa-search-plus"></i></a>
                                <a href="{{ route('pasien.edit', $user->id) }}" class="btn btn-warning btn-sm"><i
                                        class="fa fa-pencil-square-o"></i></a>
                                <form action="{{ route('pasien.destroy', $user->id) }}" method="post" id="deleteForm"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
